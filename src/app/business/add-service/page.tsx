...
export default function AddServicePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 pb-12">
      <h1 className="text-3xl font-bold tracking-tight text-primary">Add Service Package</h1>

      <Card className="shadow-lg border-2">
        <CardHeader className="bg-muted/10 border-b"><CardTitle>Service Specifications</CardTitle></CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Button type="button" variant="ghost" size="sm" onClick={handleAiDescription} disabled={generatingAi}>
            ...
            <Button type="submit" className="w-full h-12 shadow-xl" disabled={submitting}>
