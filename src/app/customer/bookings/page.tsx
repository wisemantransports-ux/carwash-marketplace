...
import { Loader2, RefreshCw, XCircle, Droplets, Calendar, Clock, MapPin, History } from "lucide-react";
...
export default function CustomerDashboardPage() {
    ...
    const fetchData = useCallback(async (silent = false) => {
        ...
        try {
            ...
            // 1. Resolve Customer Record ID (linked to this auth session)
            ...
            // 2. Fetch Wash Bookings linked to the customer record
        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-12">
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground font-medium">Manage your active carwash requests.</p>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-muted/50 border-b-2">
                            <TableHead className="font-black py-4 pl-6 uppercase text-[10px] tracking-widest">Business</TableHead>
                            ...
                            <TableRow key={booking.id} className="hover:bg-primary/5 transition-colors border-b">
                                <TableCell className="pl-6 py-5">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] text-muted-foreground font-bold uppercase">{booking.business?.city ?? 'Botswana'}</span>
                                    </div>
                                </TableCell>
                                <TableCell>
                            ...
                            <TableRow>
                                <TableCell colSpan={4} className="h-64 text-center">
                                    <div className="flex flex-col items-center justify-center gap-4 opacity-40">
                                        ...
                                        <div className="space-y-1">
                                            <p className="font-bold text-lg text-slate-900">No bookings yet</p>
                                            <p className="text-sm italic">Your carwash requests will appear here.</p>
                                        </div>
                                    </div>
                                </TableCell>
                            </TableRow>
